...
companies: [OPENAI, AMZN, SHOP, BKNG, EXPE, BABA, GOOGL, PYPL, TGT, SKIMS, GLOSSIER, SPANX]
topics: [agentic-commerce, b2b-commerce, platform-marketplaces, checkout]
companies_detail:
  - ticker: OPENAI
    focus: secondary
  - ticker: AMZN
...
ChatGPT is reportedly scaling back from an end-to-end shopping destination and pivoting to a shopping entry point that routes transactions to specialized commerce apps (source: The Information).

2/ Commerce platforms embedding agents directly in their products
...
3/ B2B commerce is seeing early agentic adoption on the sourcing side, where the workflow is highly research-intensive.
